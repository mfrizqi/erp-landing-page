    ...
    return (
        <section>
            ...
            <section className="flex flex-col lg:flex-row gap-16 md:gap-8 justify-between">
                <div className="grow">
                    <SpotlightCard className="border border-neutral-300 text-neutral-700 mb-6 p-8 h-full shadow" spotlightColor="rgba(0, 229, 255, 0.7)">
                ...
                <div className="grow">
                    <SpotlightCard className="border border-neutral-300 text-neutral-700 mb-6 p-8 h-full shadow" spotlightColor="rgba(0, 255, 153, 0.7)">
                ...
                <div className="grow">
                    <SpotlightCard className="border border-neutral-300 text-neutral-700 mb-6 p-8 h-full shadow" spotlightColor="rgba(255, 0, 225, 0.7)">
